...
var (
	Names = [...]string{
		...
		// Linda Brown Buck - American biologist and Nobel laureate best known for her genetic and molecular analyzes of the mechanisms of smell. https://en.wikipedia.org/wiki/Linda_B._Buck
		"buck",
...
func GenerateDomain() string {
	prefix := Subdomains[rand.Intn(len(Subdomains))]
